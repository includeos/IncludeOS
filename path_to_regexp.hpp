...
public:
	...
	/* Not implemented yet
  PathToRegexp(const std::regex& path, std::vector<Token>& keys,
		const std::map<std::string, bool>& options = std::map<std::string, bool>());*/

	/* Not implemented yet
  PathToRegexp(const std::vector<std::string>& path, std::vector<Token>& keys,
		const std::map<std::string, bool>& options = std::map<std::string, bool>());*/

	/* Moved this code to relevant constructor
	void string_to_regexp(const std::string& path, std::vector<Token>& keys,
	...
	/* Moved to relevant constructor
	void regexp_to_regexp(const std::regex& path, std::vector<Token>& keys);*/

	/* Moved to relevant constructor
	void vector_to_regexp(const std::vector<std::string>& path, std::vector<Token>& keys,
		const std::map<std::string, bool>& options);*/
